...
const Services = () => {
  ...
  return (
    <section id="services" className="py-24 bg-slate-light/30">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {services.map((service, index) => {
            ...
            return (
              <Card key={index} className="group hover:shadow-lg signal-transition bg-card/50 backdrop-blur-sm border hover:border-electric/20">
                <CardContent className="p-8">
                  ...
                  <Button variant="ghost" className="w-full group/btn">
                    Learn More
                    <div className="ml-2 w-4 h-4 border border-current rounded-full flex items-center justify-center">
                      <div className="w-1 h-1 bg-current rounded-full group-hover/btn:translate-x-0.5 signal-transition"></div>
                    </div>
                  </Button>
                </CardContent>
              </Card>
