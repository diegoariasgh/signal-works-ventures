      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold font-space-grotesk text-foreground mb-6">Experience across GCC, Europe, and Emerging Markets</h2>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">Signal Works is a boutique advisory supporting funds, startups, and corporates in venture and innovation. With over seven years of experience across MENA and the GCC, we bring together expertise in early-stage investing, fund strategy and operations, partnership and go-to-markt.</p>
