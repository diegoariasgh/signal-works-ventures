  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-navy to-navy-lighter">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-slate-light mb-16 max-w-3xl mx-auto leading-relaxed font-medium">Boutique advisory supporting funds, startups, and corporates in venture and innovation across the MENA region.</p>
          ...
          {/* Previous Projects */}
          <div className="mt-28 pt-12 pb-20 border-t border-white/10">
            <p className="text-slate-light/80 text-sm mb-10">Previous projects</p>
